...
url = 'http://export.finam.ru/{code}/{filename}.{extension}?market={market}&em={em}&code={code}&apply=0&df={df}&mf={11}&yf=2019&from={from_}&dt={dt}&mt={mt}&yt={yt}&to={to}&p=7&f={filename}.{extension}&cn={code}&dtf=1&tmf=1&msor=0&mstime=on&mstimever=1&sep=1&sep2=1&datf=1&at=1'
