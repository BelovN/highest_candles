...
SPB_PATH_HOUR_2020 = os.path.join(DATA_DIR, 'SBER_3YEARS_HOUR.csv')
SPB_3YEARS_15MIN = os.path.join(DATA_DIR, 'SBER_3YEARS_15MIN.csv')
...
RTS_PATH_2019_15MIN = os.path.join(DATA_DIR, 'RTS_2019_15MIN.csv')
